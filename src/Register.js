            ...
            <div className="shadow-lg p-3 mb-5 bg-white rounded">
              ...
              <form onSubmit={handleSubmit}>
                <div className="pt-5">
                  ...
                  >
                    Username Invalid <br /> Must Begin with a letter, it can
                    include letters and numbers and underscores{" "}
                  </p>
                </div>
                ...
                <div className="pt-3">
                  ...
                  >
                    Password Invalid <br /> Must Include uppercase and lowercase
                    letters, a number and a special character. <br /> Must be
                    min 8 characters{" "}
                  </p>
                </div>
                <div className="pt-3">
